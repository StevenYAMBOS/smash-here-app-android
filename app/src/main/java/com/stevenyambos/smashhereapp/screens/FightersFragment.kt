...
class FightersFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView = view.findViewById(R.id.recyclerView_Fighters) // Déplacez cette ligne avant l'utilisation de recyclerView
        ...
        searchView = view.findViewById(R.id.searchview_fighters)
    ...
    private fun filterFightersList(query: String?) {
        ...
        if (filteredList.isEmpty()) {
            Toast.makeText(context, "Aucun personnage trouvé", Toast.LENGTH_SHORT).show()
        } else {
